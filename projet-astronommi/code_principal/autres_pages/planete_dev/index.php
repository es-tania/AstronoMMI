  ...
  <?php 
    ...
    <div class="container">
        ...
        <div class="blocHorizontal">
            ...
            <a onclick="on()" role="button" href="#15"><img src="assets/img/batiment-son.png" alt="" class="batiments son"></a>
            <a onclick="on()" role="button" href="#16"><img src="assets/img/image.png" alt="" class="batiments image"></a>
            <a onclick="on()" role="button" href="#17"><img src="assets/img/Decor.png" alt="" class="batiments decor"></a>
            <a onclick="on()" role="button" href="#18"><img src="assets/img/texte.png" alt="" class="batiments texte"></a>
    ...
    <!-- Code pour que les fiches apparaissent -->
    <script>
        function on() {
