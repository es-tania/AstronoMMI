    ...
    <div class="container">
        ...
        <div class="blocHorizontal">
            ...
            <div class="slide-2">
                ...
                <a onclick="on()" id="presse"><img src="assets/img/presse.png" alt="" class="batiments texte"></a>
                <a onclick="on()" id="multimedia"><img src="assets/img/multimédia.png" alt="" class="batiments direction"></a>
            </div>
